...
class ScaleAnimation extends PageRouteBuilder {
  ...
  ScaleAnimation({required this.page})
      : super(
            pageBuilder: (context, animation, animationTo) => page,
            transitionsBuilder: (context, animation, animationTo, child) {
              var begin = 0.0;
...
class RotateAnimation extends PageRouteBuilder {
  ...
  RotateAnimation({required this.page})
      : super(
            pageBuilder: (context, animation, animationTo) => page,
            transitionsBuilder: (context, animation, animationTo, child) {
              var begin = 0.0;
...
class SizedAnimation extends PageRouteBuilder {
  ...
  SizedAnimation({required this.page})
      : super(
            pageBuilder: (context, animation, animationTo) => page,
            transitionsBuilder: (context, animation, animationTo, child) {
              return Align(
...
class ScaleRotateAnimation extends PageRouteBuilder {
  ...
  ScaleRotateAnimation({required this.page})
      : super(
            pageBuilder: (context, animation, animationTo) => page,
            transitionsBuilder: (context, animation, animationTo, child) {
              var begin = 0.0;
...
class _ExplistityAnimateState extends State<ExplistityAnimate>
