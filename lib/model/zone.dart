...
class CurrentZone{
  ...
  CurrentZone({required this.position,required this.placemark,required this.timeZoneOffset,required this.currentTime});
  ...
  CurrentZone.fromJson(Map<String,dynamic>map)
  {
    ...
    this.currentTime=DateFormat("yyyy-MM-dd HH:mm:ss.SSS").parse(map['currentTime']);
  ...
  {
     Position p=Position(
                        longitude: zone.position!.longitude, latitude: zone.position!.latitude,
                        accuracy: zone.position!.accuracy, altitude: zone.position!.altitude,
                        ...
                        speed: zone.position!.speed, speedAccuracy:zone.position!.speedAccuracy,
