...
class _PlayAudioState extends State<AzanSound> with TickerProviderStateMixin {
  ...
  void initializData() {
    soundList = [
      {
        'title': 'الأذان ',
        'subtitle': 'الشيخ ناصر القطامي',
        'path': 'sounds/azan1.mp3'
      },
      {
        'title': 'الأذان ',
        'subtitle': 'الشيخ مصطفى اسماعيل',
        'path': 'sounds/azan2.mp3'
      },
      {
        'title': 'أذان الجامع الأموي بدمشق',
        'subtitle': 'أذان جماعي',
        'path': 'sounds/azan3.mp3'
      },
      {
        'title': 'الأذان بمقام الحجاز',
        'subtitle': 'الشيخ مصطفى العزاوي',
        'path': 'sounds/azan4.mp3'
      },
    ];
