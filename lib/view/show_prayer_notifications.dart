...
class _CurrentPrayerState extends State<CurrentPrayer>
            ...
            child: Center(
                child: SlideTransition(
                    position: Tween<Offset>(
                            begin: Offset(0, -0.4), end: Offset(0, 0.4))
                        .animate(_controller),
                    child: Container(
                      decoration: const BoxDecoration(
                          image: DecorationImage(
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                              ...
                              child: Text(
                                "  حان الآن وقت صلاة ${remainingTime['name']}",
                ...
                child: Center(
                  child: IconButton(
                    ...
                    icon: Icon(
                      Icons.add_alert,
                      size: icon_size,
                      color: notif_iconColor[index] == true
                          ? Colors.orange
                          : Colors.grey,
                    ),
                  ),
              ...
              child: ListenableBuilder(
                  ...
                  builder: (
                    ...
                    return Column(
                      ...
                      children: [
                        timerFinished
                            ? Text("حان الآن وقت صلاة ${remainingTime['name']}",
                                style: Theme.of(context)
                                    .textTheme
                                    .titleMedium!
                                    .copyWith(
  ...
  drawText() {
    ...
    if (remainingHours == 0 && remainingMinutes > 0)
      text =
          "${remainingMinutes.toString().padLeft(1, '0')}:${remainingSeconds.toString().padLeft(2, '0')}";
          ...
          child: Column(
              ...
              children: [
                ...
                for (int i = 0; i < prayer_times.length + 1; i++)
                  i == 0
                      ? drawRemainingTime(prayer_times)
  ...
  void startCounter(Timer t) {
    ...
    if (remainingSeconds == 0 && remainingMinutes == 0 && remainingHours == 0) {
      ...
      if (remainingMinutes == 0 && remainingHours > 0) {
        ...
        if (remainingHours > 0) remainingHours--;
      }
    }
